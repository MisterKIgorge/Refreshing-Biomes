local assets =
{
    Asset("ANIM", "anim/quagmire_houndfish.zip"),
}
...
local function fncommon(bank, build, morphlist, custombrain, tag, data)
    ...
    inst:SetStateGraph("SGhoundfish")
...
local function fndefault()
    local inst = fncommon("quagmire_houndfish", "quagmire_houndfish", { "firehound", "icehound" }, nil, nil, {amphibious = true, canmutatefn = CanMutateFromCorpse})
...
return Prefab("houndfish", fndefault, assets, prefabs)
